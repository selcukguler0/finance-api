...
import client from "../../../utils/appwrite-connection";
...
const databases = new Databases(client, '631c28914d398195b491');
const promise = databases.createDocument('631c32d457c165faa370', 'unique()', {});
